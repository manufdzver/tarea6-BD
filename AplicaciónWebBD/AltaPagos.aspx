...
<body>
    ...
    <div style="background-color: #C0C0C0; height: 439px;">
        ...
        <br />
        <asp:Button ID="btEje" runat="server" style="z-index: 1; left: 719px; top: 310px; position: absolute; height: 75px; width: 79px" Text="Ejecutar" Visible="False" OnClick="btEje_Click" />
        <br />
...
&nbsp;&nbsp;&nbsp;<asp:Button ID="btBaja" runat="server" OnClick="btBaja_Click" style="z-index: 1; left: 344px; top: 325px; position: absolute; width: 124px; right: 638px" Text="Baja pago" Visible="False" />
        ...
        <asp:Label ID="Label4" runat="server" style="z-index: 1; left: 520px; top: 271px; position: absolute; right: 372px" Text="Fecha de pago:" Visible="False"></asp:Label>
&nbsp;<asp:GridView ID="GridView1" runat="server">
        </asp:GridView>
        <asp:Label ID="Label5" runat="server" style="z-index: 1; left: 345px; top: 411px; position: absolute" Text="Pago:" Visible="False"></asp:Label>
        <asp:DropDownList ID="ddlPago" runat="server" AutoPostBack="True" style="z-index: 1; left: 518px; top: 411px; position: absolute" Visible="False">
        </asp:DropDownList>
